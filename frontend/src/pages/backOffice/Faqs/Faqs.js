...
function Faqs() {
  ...
  return (
    <div>
      <Helmet>
        <title>Catapp | Preguntas frecuentes</title>
      </Helmet>
      <section className="general-container">
        <div className="general-content">
          ...
          <div className="faqs-content">
            ...
            <div className="one-faq">
              <div className="question-container">
                <h3 className="question">¿Cómo funciona Catapp?</h3>
                <button
                  className="toggle-button"
              ...
              {expanded[1] && (
                <div className="answer">
                  <p>
                    Catapp es una plataforma diseñada para facilitar la gestión
                    de tu negocio al permitir que tus clientes generen pedidos y
                    que tú puedas administrarlos de manera más sencilla. Para
                    comenzar a utilizar Catapp de manera efectiva, es
                  ...
                  <ol className="order-list">
                    ...
                    <li>
                      ...
                      Catapp te permite crear más usuarios internos con
                    ...
                    <li>
                      ...
                      : Catapp ofrece la posibilidad de obtener estadísticas
            ...
            <div className="one-faq">
              <div className="question-container">
                <h3 className="question">
                  ...
                  recibido por WhatsApp en Catapp?
                </h3>
                <button
                  className="toggle-button"
