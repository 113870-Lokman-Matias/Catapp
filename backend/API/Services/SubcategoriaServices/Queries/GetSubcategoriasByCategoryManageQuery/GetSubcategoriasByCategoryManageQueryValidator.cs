...
{
  public class GetSubcategoriasByCategoryManageQueryValidator : AbstractValidator<GetSubcategoriasByCategoryManageQuery>
  {
    private readonly CatalogoContext _context;

    public GetSubcategoriasByCategoryManageQueryValidator(CatalogoContext context)
    {
      _context = context;
