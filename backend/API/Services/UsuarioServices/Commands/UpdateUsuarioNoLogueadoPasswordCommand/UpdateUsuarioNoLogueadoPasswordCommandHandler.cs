...
{
    public class UpdateUsuarioNoLogueadoPasswordCommandHandler : IRequestHandler<UpdateUsuarioNoLogueadoPasswordCommand, UsuarioDto>
    {
        private readonly CatalogoContext _context;
        private readonly IMapper _mapper;
        private readonly IValidator<UpdateUsuarioNoLogueadoPasswordCommand> _validator;

        public UpdateUsuarioNoLogueadoPasswordCommandHandler(CatalogoContext context, IMapper mapper, IValidator<UpdateUsuarioNoLogueadoPasswordCommand> validator)
        {
            _context = context;
            _mapper = mapper;
        ...
        public async Task<UsuarioDto> Handle(UpdateUsuarioNoLogueadoPasswordCommand request, CancellationToken cancellationToken)
        {
            try
            {
